...
CUDA_VISIBLE_DEVICES=0 python test.py --sam_mode sam --task abdomen --dataset sabs_sammed --model_type vit_b --sam_checkpoint ../../data/experiments/weights/sam_vit_b_01ec64.pth --prompt fssp --scale 0.01
...
CUDA_VISIBLE_DEVICES=0 python test.py --sam_mode med_sam --task abdomen --dataset sabs_sammed --model_type vit_b --sam_checkpoint ../../data/experiments/weights/medsam_vit_b.pth  --prompt fssp --scale 0.01
