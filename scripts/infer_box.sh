...
# sam_med2d
# base
# CUDA_VISIBLE_DEVICES=0 python test.py --sam_mode sam_med2d --model_type vit_b --sam_checkpoint /home/yanzhonghao/data/ven/sam-med2d/sam-med2d_b.pth --prompt box --strategy base
